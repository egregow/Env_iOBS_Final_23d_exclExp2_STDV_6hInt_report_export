...
v[3] = ['ALL'] ;
t[3] = v[3] ;
v[4] = ['PS','FF','GX','DD','TT','TTHA','TN','TX','TD','TDD','RH','QQ','NN','PE1','PE3','VI']
t[4] = ['Mslp','U10m','Max Wind Gust','Wind direction','T2m','T2m, height corr.','Min T2m','Max T2m','Td2m','Td2m deficit','Rh2m','Q2m','Cloud cover','1h Precipitation','3h Precipitation','Visibility']
v[5] = [0]
v[5] = v[5].reverse()
t[5] = v[5]
v[6] = ['Ref_Exp1','Ref_Exp3','Ref_Exp4','Ref_Exp5']
t[6] = ['Ref_Exp1','Ref_Exp3','Ref_Exp4','Ref_Exp5']
v[7] = ['ALL'] ;
t[7] = v[7] ;
